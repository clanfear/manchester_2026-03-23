...
format:
  revealjs:
    ...
    auto-stretch: true
    title-slide: false
    pagetitle: "Policing, the life course, and social change: Recent research and new questions"
editor: source
mouse-wheel: true
history: false
---
...
## [Policing, the life course,</br>and social change:]{.r-fit-text} {background-image="img/stephan-cassara-KnAIsBuitGg-unsplash.jpg" background-opacity="0.4"}
...
## [Dual pathway model of gun carrying and gun violence]{.r-fit-text}{background-image="img/benjamin-suter-mlOvsx4xdaA-unsplash.jpg" background-opacity="0.2"}
...
## Age, period, and cohort effects {background-image="img/benjamin-suter-mpLex62zVKQ-unsplash.jpg" background-opacity="0.2"}
...
## Feedback and questions {background-image="img/joel-mott-s-rsM-AktbA-unsplash.jpg" background-opacity="0.3"}
